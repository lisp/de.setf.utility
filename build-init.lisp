...
;;;
;;; a universal comment-reader for eol == linefeed or return
...
;;; if there is an asdf system definition directory, place it after the source root in order that
;;; hierarchical search results take precedence
...
;;;
;;; add uniform utility operators for existing and saving an image
